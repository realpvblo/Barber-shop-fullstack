                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0" data-bs-toggle="modal" data-bs-target="#feedbackModal">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="small">Umów wizytę</span>
                        </span>
                    </button>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            ...
                            <div class="d-flex flex-column flex-lg-row align-items-center">
                                <button type="button" class="btn btn-dark">Umów wizytę</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <div class="device-wrapper">
                                <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                    <div class="screen bg-black">
                                        ...
                                        <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%"><source src="Bootstrap\assets\img\production ID_3997183.mp4" type="video/mp4" /></video>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row gx-5">
                                <div class="col-md-6 mb-5">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">Na bieżąco się szkolimy i wygrywamy nagrody za jakość naszych usług!</p>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-5">
                                    <!-- Feature item-->
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">Nasi klienci nas kochają. Przyjdź i przekonaj się dlaczego!</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-5 mb-md-0">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">Od strzyżenia przez malowanie do przedłużania. Dla nas nie ma rzeczy niewykonalnych!</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <!-- Feature item-->
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">Cały zespół z radością pomoże nawet najbardziej wymagającym klientom!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="device-wrapper">
                                <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                    <div class="screen bg-black">
                                        ...
                                        <!-- * * Set the max width of your media to 100% and the height to-->
                                        <!-- * * 100% like the demo example below.-->
                                        <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%"><source src="Bootstrap\assets\img\production ID_3998519.mp4" type="video/mp4" /></video>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-12 col-lg-5">
                        ...
                        <p class="lead fw-normal text-muted mb-5 mb-lg-0">Radosna etyka pracy Pawła i Mateusza sprawia, że ERA Fresh na co dzień spełnia wymagania nawet najbardziej wymagających klientów.</p>
                    </div>
                    <div class="col-sm-8 col-md-6">
                        <div class="px-5 px-sm-0"><img class="img-fluid rounded-circle" src="Bootstrap\assets\img\Bez nazwy-11.png" alt="..." /></div>
                    </div>
                </div>
            </div>
        </section>
